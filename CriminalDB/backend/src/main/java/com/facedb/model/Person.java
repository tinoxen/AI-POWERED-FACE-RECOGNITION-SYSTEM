...
public class Person {
    ...
    /**
     * The person's biometric "faceprint": a 512-dimensional ArcFace
     * embedding produced from their photo, stored as a comma-separated list
     * of floats. Two faces are compared by taking the cosine similarity
     * between their embeddings (see PersonService). Null if no photo has
     * been uploaded yet or the last uploaded photo failed face detection.
     */
    @Column(columnDefinition = "TEXT")
